                    ...
                    <div class="contact_form">
                        <form action="{{url('send_message')}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="message" id="" class="form-control" cols="5" rows="4" placeholder="Write Your Message"></textarea>
                                @error('message')
                                <div class="alert alert-danger">
                                    <strong>{{$message}}</strong>
                                </div>
                            ...
                            <div class="form-group">
                                <button class="btn btn-success btn-outline-success" type="submit">Send Message</button>
                            </div>
                        </form>
                    </div>
                </div>
