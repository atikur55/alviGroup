            ...
            <div class="modal-body">
                <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="twitter" class="form-control" value="{{$footer->twitter}}" readonly/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="google" class="form-control" value="{{$footer->google}}" readonly/>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{url('admin/update/footer')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Footer Phone Number:</label>
                        <input type="text" name="mobile" class="form-control" value="{{$footer->mobile}}"/>                    </div>
                    <div class="form-group">
                        <label>Social Facebook Link:</label>
                    ...
                    <div class="form-group">
                        <label>Social Google+ Link:</label>
                        <input type="text" name="google" class="form-control" value="{{$footer->google}}"/>
                    </div>
                    <div class="form-group">
                        <label>Social Youtube Link:</label>
