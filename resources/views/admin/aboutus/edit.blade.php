						...
						<div class="card-body">
						  	<form action="{{url('admin/update/aboutus')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description_one" rows="4" cols="4" class="form-control">{{$data->description_one}}</textarea>
                                    <input type="hidden" name="id" value="{{$data->id}}">
                                </div>
                                <div class="form-group">
                                     <label>Description Two</label>
                                    <textarea name="description_two" rows="4" cols="4" class="form-control">{{$data->description_two}}</textarea>
                                </div>
                                <div class="form-group">
                                     <label>Photo</label>
