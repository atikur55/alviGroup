            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-custom">
						...
						<div class="card-body">
						  	<form action="{{url('admin/post/aboutus')}}" method="POST" enctype="multipart/form-data">
						  		@csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description_one" rows="4" cols="4" class="form-control"></textarea>
                                </div>
                                <div class="form-group">
                                     <label>Description Two</label>
                                    <textarea name="description_two" rows="4" cols="4" class="form-control"></textarea>
                                </div>
                                <div class="form-group">
                                     <label>Photo</label>
