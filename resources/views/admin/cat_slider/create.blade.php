    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <h6 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Add Category Slider</h6>
                <!--end::Actions-->
            </div>
            <!--end::Info-->
        </div>
                    ...
                    <div class="card card-custom">
					 	<div class="card-header">
						    <div class="card-title">
						   		<h3 class="card-label">Create New Category Slider</h3>
						    </div>
						  	...
						  	<div class="row">
						  		<div class="col-lg-10 m-auto">
						  			<form action="{{url('admin/post/ca_slider')}}" method="POST" enctype="multipart/form-data">
										...
										<div class="form-group">
										    <label>Category Slider Photo [Size Max 1Mb]</label>
