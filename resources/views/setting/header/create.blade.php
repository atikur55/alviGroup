    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <h6 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Header Setting</h6>
                <!--end::Actions-->
            </div>
            <!--end::Info-->
        </div>
                    ...
                    <div class="card card-custom">
					 	<div class="card-header">
						    <div class="card-title">
						   		<h3 class="card-label">All Header Setting List</h3>
						    </div>
					                        ...
					                        <div class="modal-dialog" role="document">
					                            <div class="modal-content">
					                                ...
					                                <div class="modal-body">
					                                   	<form action="{{url('admin/setting/header/post')}}" method="POST" enctype="multipart/form-data">
					                                   		@csrf
					                            <div class="form-group">
												   <label>Header Name:</label>
												   <input type="text" class="form-control form-control-solid" name="header_name" />
											...
											<tbody>
												...
												<tr>
													...
													<td>
														...
														<a href="#statusModal{{$header->id}}" data-toggle="modal" class="btn btn-success"  ><i class="fas fa-toggle-off icon-md"></i>Active
					                                    </a>
														@else
														<a href="#statusModal{{$header->id}}" data-toggle="modal" class="btn btn-danger"  ><i class="fas fa-toggle-on icon-md"></i></i> Deactive
					                                    </a>
														@endif
													</td>
											</tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
            	@if($header->display == 'block')
                <a href="{{url('admin/setting/header/status')}}/{{$header->id}}" class="btn btn-danger">Deactive</a>
                @else
                <a href="{{url('admin/setting/header/status')}}/{{$header->id}}" class="btn btn-success">Active</a>
                @endif
